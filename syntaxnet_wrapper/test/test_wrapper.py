...
5\ttest\t_\t_\t_\tGender=Masc|Number=Sing|fPOS=NOUN++\t0\t_\t_\t_\n\n"""
    ...
    def test_morpho_sentences(self):
        ...
        self.assertEqual(results, wrapper.morpho_sentences(input_sentences))
    ...
    def test_morpho_transform(self):
        ...
        self.assertEqual(result, wrapper.transform_morpho(input_morpho))
    ...
    def test_tag_sentences(self):
        ...
        self.assertEqual(result, wrapper.tag_sentences(input_sentences))
    ...
    def test_transform_tag(self):
        ...
        self.assertEqual(result, wrapper.transform_tag(input_tag))
    ...
    def test_parse_sentences(self):
        ...
        self.assertEqual(result, wrapper.parse_sentences(input_sentences))
    ...
    def test_transform_dependency(self):
        ...
        self.assertEqual(result, wrapper.transform_dependency(input_dependency, input_sentence))
