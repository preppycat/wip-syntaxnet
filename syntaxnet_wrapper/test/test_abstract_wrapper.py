...
class TestAbstractWrapper(TestCase):
    ...
    def test_transform_dependency(self):
        ...
        result = [{'edges': [{'vertice_b': 1, 'index': '2_1', 'vertice_a': 2, 'is_directed': True, 'attributes': {'relation': u'det'}}], 'vertice': {'index': 1, 'attributes': {'token': u'Cette', 'relation': u'det', 'parent': 2, 'pos': u'_', 'feats': u'Gender=Fem|Number=Sing|fPOS=DET++', 'label': u'DET'}}}, {'edges': [{'vertice_b': 1, 'index': '2_1', 'vertice_a': 2, 'is_directed': True, 'attributes': {'relation': u'det'}}, {'vertice_b': 2, 'index': '5_2', 'vertice_a': 5, 'is_directed': True, 'attributes': {'relation': u'nsubj'}}], 'vertice': {'index': 2, 'attributes': {'token': u'phrase', 'relation': u'nsubj', 'parent': 5, 'pos': u'_', 'feats': u'Gender=Fem|Number=Sing|fPOS=NOUN++', 'label': u'NOUN'}}}, {'edges': [{'vertice_b': 3, 'index': '5_3', 'vertice_a': 5, 'is_directed': True, 'attributes': {'relation': u'cop'}}], 'vertice': {'index': 3, 'attributes': {'token': u'est', 'relation': u'cop', 'parent': 5, 'pos': u'_', 'feats': u'Mood=Ind|Number=Sing|Person=3|Tense=Pres|VerbForm=Fin|fPOS=VERB++', 'label': u'VERB'}}}, {'edges': [{'vertice_b': 4, 'index': '5_4', 'vertice_a': 5, 'is_directed': True, 'attributes': {'relation': u'det'}}], 'vertice': {'index': 4, 'attributes': {'token': u'un', 'relation': u'det', 'parent': 5, 'pos': u'_', 'feats': u'Definite=Ind|Gender=Masc|Number=Sing|PronType=Dem|fPOS=DET++', 'label': u'DET'}}}, {'edges': [{'vertice_b': 2, 'index': '5_2', 'vertice_a': 5, 'is_directed': True, 'attributes': {'relation': u'nsubj'}}, {'vertice_b': 3, 'index': '5_3', 'vertice_a': 5, 'is_directed': True, 'attributes': {'relation': u'cop'}}, {'vertice_b': 4, 'index': '5_4', 'vertice_a': 5, 'is_directed': True, 'attributes': {'relation': u'det'}}], 'vertice': {'index': 5, 'attributes': {'token': u'test', 'relation': u'ROOT', 'parent': 0, 'pos': u'_', 'feats': u'Gender=Masc|Number=Sing|fPOS=NOUN++', 'label': u'NOUN'}}}]
